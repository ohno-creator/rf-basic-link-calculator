  ...
  return (
    <section className="flex flex-col rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-5">
        ...
        >
          <p>
            dBは比（倍率）の対数で、10倍ごとに+10dBになります。1,000,000,000,000倍も「120dB」と3桁で書け、掛け算を足し算で扱えます（送信出力＋利得−損失…）。電波は距離・壁・天候で割合的に減るため、リンクバジェットはまさにこのdBの足し引きで「どこまで届くか」を見積もります。距離は自由空間損失が距離の2乗（20log10）で効くので、6dBの上積みで到達距離が2倍になります。
          </p>
        </FormulaExplanationCard>
      </div>
    </section>
