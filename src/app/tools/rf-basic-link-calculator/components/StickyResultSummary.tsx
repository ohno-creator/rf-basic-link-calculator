 ...
 */
export function StickyResultSummary({ result, targetId }: StickyResultSummaryProps) {
  ...
  return (
    ...
    >
      <button
        ...
        className="pointer-events-auto mx-auto flex w-full max-w-xl items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white/95 px-4 py-3 shadow-soft backdrop-blur transition hover:border-staf/40"
      >
