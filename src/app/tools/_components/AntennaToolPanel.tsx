  ...
  switch (toolId) {
    ...
    case "reflector-ris-size-effect": {
      ...
      return {
        ...
        warning: result.clampedToMirrorLimit
          ? "大開口・近距離のため鏡面反射の下限で評価。RIS/反射板の厳密な回線設計には、面の位相分布、反射係数、偏波、入射角、設置環境を含む電磁界解析または実測が必要です。"
          : "RIS/反射板の厳密な回線設計には、面の位相分布、反射係数、偏波、入射角、設置環境を含む電磁界解析または実測が必要です。"
      };
    }
  }
}
