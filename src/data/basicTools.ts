...
export const basicTools: BasicToolMeta[] = [
  ...
  },
  {
    ...
    description:
      "複数アンテナで電波の向きを作るとき、間隔が広すぎると狙った方向とは別の方向にも強い電波の山が出ます。このツールでは、その意図しない強いビームが出る条件を確認します。",
    formula: "|sinθ0 + mλ/d| ≤ 1",
    essenceLead: "狙った方向以外にも強いビームが出るかどうかを、間隔と向きから確認します。",
    beginnerGuide: {
      purpose: "複数アンテナでビームを作る時、狙っていない方向にも強く飛ばないかを確認します。",
      inputs: "周波数、アンテナ同士の間隔、向けたい方向を入れます。",
      result: "不要ビームが出る可能性ありなら、間隔を狭めるか、向ける角度を小さくします。"
    },
