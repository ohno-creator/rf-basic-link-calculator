...
export const tools: ToolEntry[] = [
  ...
  {
    "slug": "resonant-element-length",
    "name": "共振素子長（モノポール/ダイポール）",
    "tagline": "この周波数で線は何mmかを即算",
    "icon": "ruler",
    "category": "antenna",
    "basic": {
      "title": "共振素子長（モノポール/ダイポール）",
      "metaTitle": "共振素子長 計算ツール｜λ/4モノポール・λ/2ダイポールの物理長",
      "description": "周波数から、λ/4モノポール・λ/2ダイポール・全波素子の物理長を計算します。端部効果の短縮率k（既定0.95）と被覆線・巻線の波長短縮率VFを掛けて、実装で切る線・ホイップの初期長の目安を出します。",
      "scopeNote": "初期値の目安です。実際は基板GND・給電・近接部品で共振がずれるため、量産前は実測での追い込みを前提にしてください。",
      "formula": "物理長 = 分数(1/4・1/2・1)×λ×短縮率k×波長短縮VF、λ[m]=300/周波数[MHz]",
      "essenceLead": "共振長は波長の分数が基本で、端部効果で数%短くなり、被覆線・巻線ではさらに短縮します。",
      "beginnerGuide": {
        "purpose": "使う周波数に対して、アンテナのエレメント（線）を何mmで切ればよいかの初期値を素早く出します。",
        "inputs": "①周波数②素子タイプ（λ/4モノポール・λ/2ダイポール・全波）③短縮率k（既定0.95）④被覆線なら波長短縮率VF。",
        "result": "実用エレメント全長（ダイポールは片側長も）が出ます。これを起点に実測で追い込みます。"
      }
    }
  },
  {
    "slug": "far-field-distance",
    "name": "遠方界距離（測定距離の目安）",
    "tagline": "OTA・暗室で何m離せば測れるか",
    "icon": "radar",
    "category": "antenna",
    "basic": {
      "title": "遠方界距離（測定距離の目安）",
      "metaTitle": "遠方界距離 計算ツール｜フラウンホーファ 2D²/λ と近傍界の境界",
      "description": "アンテナ最大寸法Dと周波数から、反応近傍界の上限0.62√(D³/λ)・遠方界の開始2D²/λ・実用の測定推奨距離を計算します。電気的に小さいアンテナ（D<λ）では波長基準(3λ)が支配的になる点も注記します。",
      "scopeNote": "遠方界は 2D²/λ に加え r≫λ・r≫D も要件です。本ツールは実用目安として max(2D²/λ, 3λ, 反応近傍上限) を採用します。",
      "formula": "反応近傍 r<0.62√(D³/λ)／放射近傍 0.62√(D³/λ)≤r<2D²/λ／遠方界 r≥2D²/λ",
      "essenceLead": "遠方界ではパターンが距離によらず一定になり、開口が大きいほど 2D²/λ は急に伸びます。",
      "beginnerGuide": {
        "purpose": "アンテナ測定・OTA・電波暗室で、どれだけ離せば遠方界として測れるかの目安を出します。",
        "inputs": "①周波数②アンテナ最大寸法D（開口の最大差し渡し）。",
        "result": "3領域の境界と測定推奨距離が出ます。小型アンテナでは r≳数λ が支配的になります。"
      }
    }
  },
  {
    "slug": "realized-gain",
    "name": "実効利得・利得変換",
    "tagline": "指向性×効率×整合＝実現利得",
    "icon": "antenna",
    "category": "antenna",
    "basic": {
      "title": "実効（実現）利得と利得変換",
      "metaTitle": "実効利得 計算ツール｜指向性×放射効率×整合損とdBi/dBd変換",
      "description": "指向性・放射効率・VSWRから、利得（=指向性+10log η）と実現利得（=利得−不整合損失）、総合効率、dBi↔dBd換算を計算します。データシートの『利得』が何を含むかの混乱を解消します。",
      "scopeNote": "dBdは半波長ダイポール基準（dBi−2.15）。円偏波×直線偏波の受信ではさらに約3dBの偏波損が加わります。",
      "formula": "利得=指向性+10log10(η)、実現利得=利得−(−10log10(1−|Γ|²))、|Γ|=(VSWR−1)/(VSWR+1)",
      "essenceLead": "利得は指向性に放射効率を掛けたもので、さらに整合損失を引くと系が実際に得る実現利得になります。",
      "beginnerGuide": {
        "purpose": "アンテナの利得表記を正しく解釈し、リンクバジェットに入れる利得の妥当性を確認します。",
        "inputs": "①指向性[dBi]②放射効率[%]③入力整合のVSWR。",
        "result": "利得・実現利得・総合効率・dBi/dBd換算が出ます。定義を揃えて他品と比較できます。"
      }
    }
  },
  {
    "slug": "field-strength",
    "name": "電界強度・電力密度",
    "tagline": "EIRPと距離から E・S・受信電力",
    "icon": "waves",
    "category": "basics",
    "basic": {
      "title": "電界強度・電力密度（EIRPと距離から）",
      "metaTitle": "電界強度・電力密度 計算ツール｜EIRPと距離からV/m・dBµV/m・W/m²",
      "description": "送信源のEIRPと距離から、電力密度S[W/m²・mW/cm²]と電界強度E[V/m・dBµV/m]を計算します。周波数と受信利得を与えれば受信電力も換算します。規制（電波防護指針）・実測・受信レベルの一次見積もりに。",
      "scopeNote": "遠方界・自由空間の理想条件です。反射・地面・多重波のある実環境では変動します。一次目安として使ってください。",
      "formula": "S=EIRP/(4πr²)、E=√(η0·S)=√(30·EIRP[W])/r、E[dBµV/m]=20log10(E/1µV)、Prx=S·Gλ²/4π",
      "essenceLead": "電力は球面に広がって距離の2乗で薄まり、自由空間インピーダンスη0≈377Ωで電界強度に換算できます。",
      "beginnerGuide": {
        "purpose": "ある地点の電界強度・電力密度・受信レベルを、EIRPと距離から一気に見積もります。",
        "inputs": "①送信源のEIRP[dBm]②距離r。任意で③周波数④受信アンテナ利得（受信電力も出す場合）。",
        "result": "E[V/m・dBµV/m]・S[W/m²・mW/cm²]、指定時は受信電力[dBm]が出ます。"
      }
    }
  }
];
