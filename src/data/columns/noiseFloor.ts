...
export const noiseFloorColumn: ToolColumn = {
  ...
  hook: "1932年、ベル研究所のカール・ジャンスキーは大西洋横断無線のパチパチという雑音の犯人捜しを命じられていました。雷、船の火花点火、電源……原因を一つずつ潰していくと、どうしても消えない「シューッ」という成分が残ります。しかもそれは23時間56分周期——地球の自転に対する星の周期で強弱を繰り返していました。犯人は天の川の中心。雑音退治の仕事が、電波天文学という学問を生んだ瞬間です。",
  body: [
