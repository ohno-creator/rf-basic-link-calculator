...
| S2 | E. O. Hammerstad (1975) | paper | [ieee.org](https://ieeexplore.ieee.org/document/1622204) | pp. 268-272 | *“Equations for Microstrip Circuit Design”* (IEEE MTTS)。実効比誘電率およびフリンジ延長長（$\Delta L$）の業界標準的な高精度近似式。 | 2026-07 | ○ |
